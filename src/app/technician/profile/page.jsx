      ...
      <div className="flex p-4  flex-col md:flex-row md:justify-between">
        ...
        <div className="w-full md:w-1/2 px-0 md:px-4  text-gray-300">
          ...
          <h4 className="text-lg my-4 flex items-center">
            ...
            Location:
            <a href={`https://www.google.com/maps/search/?api=1&query=${data.location.lat},${data.location.lat}`} target="_blank"className="text-gray-300 cursor-pointer hover:text-primary transition-color duration-300 "> <FaMapMarkedAlt className="ml-4 text-2xl"/> </a>
          </h4>
