...
const Header = () => {
  ...
  >
  <div className={` transition duration-500 absolute inset-0 h-full w-full bg-gradient-to-r from-gray-800 to-gray-700 z-10  ${scrollPosition > 150 ? "opacity-100" : "opacity-0"}`}></div>
      <Image
        loading="eager"
        priority={true}
        src={logo2}
